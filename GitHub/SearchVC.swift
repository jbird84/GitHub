...
//  GitHub
//
//  Created by Kinney Kare on 2/1/20.
...
class SearchVC: UIViewController {
    ...
    @objc func pushFollowerListVC() {
        ...
        guard isUsernameEntered else {
            presentGFAlertOnMainThread(title: "Empty Username", message: "Please enter a usermane. We need to know who to look for.", buttonTitle: "Got It")
            return
        }
